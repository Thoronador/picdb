...
#ifndef CMDTAGSTATISTICS_HPP
#define CMDTAGSTATISTICS_HPP

#include "Command.hpp"

/** \brief command for showing tag statistics of a database
 */
class CommandTagStatistics: public Command
{
  public:
    /** \brief constructor */
    CommandTagStatistics();
