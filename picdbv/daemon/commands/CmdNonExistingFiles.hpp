...
#ifndef CMDNONEXISTINGFILES_HPP
#define CMDNONEXISTINGFILES_HPP

#include "Command.hpp"

/** \brief class for getting a list of files that are in the DB but not on the physical medium any more
 */
class CommandNonExistingFiles: public Command
{
  public:
    /** \brief constructor */
    CommandNonExistingFiles();
