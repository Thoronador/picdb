...
#ifndef CMDUNKNOWNWHO_HPP
#define CMDUNKNOWNWHO_HPP

#include "Command.hpp"

/** \brief command for listing files with no "who" info in the database
 */
class CommandUnknownWho: public Command
{
  public:
    /** \brief constructor */
    CommandUnknownWho();
