...
#ifndef CMDLISTDATABASES_HPP
#define CMDLISTDATABASES_HPP

#include "Command.hpp"

/** \brief commmand for listing all available databases
 */
class CommandListDatabases: public Command
{
  public:
    /** \brief constructor */
