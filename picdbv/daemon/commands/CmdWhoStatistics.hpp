...
#ifndef CMDWHOSTATISTICS_HPP
#define CMDWHOSTATISTICS_HPP

#include "Command.hpp"

/** \brief command for showing person statistics of a database
 */
class CommandWhoStatistics: public Command
{
  public:
    /** \brief constructor */
    CommandWhoStatistics();
