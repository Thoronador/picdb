...
#ifndef CMDFILEDATA_HPP
#define CMDFILEDATA_HPP

#include "Command.hpp"

/** \brief command for getting a file's data from a database
 */
class CommandFileData: public Command
{
  public:
    /** \brief constructor */
    CommandFileData();
