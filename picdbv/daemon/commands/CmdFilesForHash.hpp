...
#ifndef CMDFILESFORHASH_HPP
#define CMDFILESFORHASH_HPP

#include "Command.hpp"

/** \brief command for getting all files that are known to have a given hash value
 */
class CommandFilesForHash: public Command
{
  public:
    /** \brief constructor */
    CommandFilesForHash();
