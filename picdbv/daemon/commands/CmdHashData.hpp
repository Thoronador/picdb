...
#ifndef CMDHASHDATA_HPP
#define CMDHASHDATA_HPP

#include "Command.hpp"

/** \brief command for getting a hash's data from a database
 */
class CommandHashData: public Command
{
  public:
    /** \brief constructor */
    CommandHashData();
