...
#ifndef CMDFILESFROMDIRECTORY_HPP
#define CMDFILESFROMDIRECTORY_HPP

#include "Command.hpp"

/** \brief command for saving a database to a file
 */
class CommandFilesFromDirectory: public Command
{
  public:
    /** \brief constructor */
    CommandFilesFromDirectory();
...
#endif // CMDFILESFROMDIRECTORY_HPP
