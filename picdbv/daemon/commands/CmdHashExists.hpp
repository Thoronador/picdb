...
#ifndef CMDHASHEXISTS_HPP
#define CMDHASHEXISTS_HPP

#include "Command.hpp"

/** \brief class for checking existence of a certain hash in a database
 */
class CommandHashExists: public Command
{
  public:
    /** \brief constructor */
    CommandHashExists();
