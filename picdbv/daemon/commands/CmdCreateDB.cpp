...
#include "CmdCreateDB.hpp"
#include "../constants.hpp"
#include "../../data/DatabaseManager.hpp"

CommandCreateDatabase::CommandCreateDatabase()
: Command("create_db")
{ }

bool CommandCreateDatabase::processMessage(const std::string& message, std::string& answer) const
{
  /* create a new database */
  if (message.size() > 10 && (message.substr(0, 10) == "create_db "))
  {
