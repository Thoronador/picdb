...
#ifndef CMDUNKNOWNARTIST_HPP
#define CMDUNKNOWNARTIST_HPP

#include "Command.hpp"

/** \brief command for listing files with no artist info in the database
 */
class CommandUnknownArtist: public Command
{
  public:
    /** \brief constructor */
    CommandUnknownArtist();
