...
#ifndef CMDADDFILE_HPP
#define CMDADDFILE_HPP

#include "Command.hpp"

/** \brief class for adding a file (and its information) to a database
 */
class CommandAddFile: public Command
{
  public:
    /** \brief constructor */
    CommandAddFile();
