...
#ifndef CMDAUTOTAGDB_HPP
#define CMDAUTOTAGDB_HPP

#include "Command.hpp"

/** \brief command for trying to "tag" all contents of a database
 */
class CommandAutoTagDB: public Command
{
  public:
    /** \brief constructor */
    CommandAutoTagDB();
