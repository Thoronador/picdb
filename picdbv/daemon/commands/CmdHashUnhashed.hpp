...
#ifndef CMDHASHUNHASHED_HPP
#define CMDHASHUNHASHED_HPP

#include "Command.hpp"

/** \brief class for adding hashes to (yet) unhashed files in the database
 */
class CommandHashUnhashed: public Command
{
  public:
    /** \brief constructor */
    CommandHashUnhashed();
