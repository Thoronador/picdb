...
#ifndef CMDDELETEFILE_HPP
#define CMDDELETEFILE_HPP

#include "Command.hpp"

/** \brief command for deleting a file from a database
 */
class CommandDeleteFile: public Command
{
  public:
    /** \brief constructor */
    CommandDeleteFile();
